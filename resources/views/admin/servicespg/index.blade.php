...
@section('content')
            ...
            <div class="card-header"><i class="fas fa-table mr-1"></i>Service  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="{{route('ser.create')}}" class="btn btn-outline-info btn-sm">Add New</a></div>
                                    ...
                                    <table class="table table-bordered" id="slidesser">
                                        ...
                                        <tbody>
                                            @foreach ($sers as $slide)
                                                   <tr>
                                            <td>{{$slide->title}}<br>
                        <span><a href="{{route('ser.edit',['id' => $slide->id])}}" class="text-info">Edit</a> | <a href="{{route('ser.delete',['id' => $slide->id])}}" onclick = "return confirm('Are you sure you want to trash this record');" class="text-danger">Trash</a></span>
                                            </td>
