...
<html class="no-js" lang="en">
    <head>
                            ...
                            <div class="row align-items-center h-100 xl-ps-10 sm-ps-0">
                                <div class="col-xxl-7 col-xl-10 text-white">
                                    ...
                                    <div class="lg-mb-8 md-mb-0">
                                        <a href="our-services.php" class="btn btn-white btn-extra-large btn-round-edge fw-700 btn-box-shadow me-35px">Our Services</a>
                    ...
                    <div class="col-xl-5 outside-box-top-205px lg-mt-0 position-relative z-index-1">
                        <div class="border-radius-10px overflow-hidden">
                            ...
                            <div class="bg-dark-gray ps-50px pe-50px pt-20px pb-20px sm-ps-30px sm-pe-30px">
                                <a href="contact-us.php" class="fs-19 fw-500 text-white d-flex w-100 align-items-center">Get a Free Quote Today<i class="feather icon-feather-plus ms-auto icon-extra-medium"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-xl-5 col-lg-6 col-md-10 offset-xl-1" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <div class="mt-35px d-flex flex-wrap">
                            <a href="our-services.php" class="btn btn-large btn-dark-gray btn-hover-animation-switch btn-round-edge btn-box-shadow btn-icon-right me-30px">
                                <span> 
                            ...
                            <div class="feature-box feature-box-left-icon-middle xs-mt-20px">
                                ...
                                <div class="feature-box-content">
                                    ...
                                    <a href="tel:778-700-4046" class="d-block text-dark-gray fw-700">778-700-4046</a>
                                </div>
                            </div>
                        </div>
                    </div> 
                            ...
                            <div class="swiper slider-one-slide" data-slider-options='{ "slidesPerView": 1, "spaceBetween": 30, "loop": true, "navigation": { "nextEl": ".slider-one-slide-next-1", "prevEl": ".slider-one-slide-prev-1" }, "autoplay": { "delay": 4000, "disableOnInteraction": false }, "keyboard": { "enabled": true, "onlyInViewport": true }, "breakpoints": { "1200": { "slidesPerView": 4 }, "992": { "slidesPerView": 3 }, "768": { "slidesPerView": 2 }, "320": { "slidesPerView": 1 } }, "effect": "slide" }'>
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="services-box-style-03 last-paragraph-no-margin border-radius-6px overflow-hidden">
                                            <div class="position-relative">
                                                <a href="residential-moving.php"><img src="images/5.jpg" alt=""></a>
                                               
                                            </div>
                                            <div class="bg-white">
                                                <div class="ps-65px pe-65px pt-30px pb-30px text-center">
                                                    <a href="residential-moving.php" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Residential Moving</a>
                                                    <p>Making Your Move Feel Like Home.</p> 
                                                </div> 
                                                <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                    <a href="residential-moving.php" class="btn btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
                                                        <span>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="services-box-style-03 last-paragraph-no-margin border-radius-6px overflow-hidden">
                                            <div class="position-relative">
                                                <a href="commercial-moving.php"><img src="images/6.jpg" alt=""></a>
                                                
                                            </div>
                                            <div class="bg-white">
                                                <div class="ps-65px pe-65px pt-30px pb-30px text-center">
                                                    <a href="commercial-moving.php" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Commercial Moving</a>
                                                    <p>Efficient Office Relocations for Your Business</p> 
                                                </div> 
                                                <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                    <a href="commercial-moving.php" class="btn btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
                                                        <span>
                                                            <span class="btn-text">Explore services</span>
                                                            <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
                                                            <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="services-box-style-03 last-paragraph-no-margin border-radius-6px overflow-hidden">
                                            <div class="position-relative">
                                                <a href="packing-services.php"><img src="images/7.jpg" alt=""></a>
                                                
                                            </div>
                                            <div class="bg-white">
                                                <div class="ps-65px pe-65px pt-30px pb-30px text-center">
                                                    <a href="packing-services.php" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Packing Services</a>
                                                    <p>Leave the Packing to Us</p> 
                                                </div> 
                                                <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                    <a href="packing-services.php" class="btn btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
                                                        <span>
                                                            <span class="btn-text">Explore services</span>
                                                            <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
                                                            <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="services-box-style-03 last-paragraph-no-margin border-radius-6px overflow-hidden">
                                            <div class="position-relative">
                                                <a href="move-out-cleaning.php"><img src="images/8.jpg" alt=""></a>
                                                
                                            </div>
                                            <div class="bg-white">
                                                <div class="ps-65px pe-65px pt-30px pb-30px text-center">
                                                    <a href="move-out-cleaning.php" class="d-inline-block fs-18 fw-700 text-dark-gray mb-5px">Move-Out Cleaning</a>
                                                    <p>Lorem ipsum simply dummy text of amet consectetur.</p> 
                                                </div> 
                                                <div class="d-flex justify-content-center border-top border-color-extra-medium-gray pt-20px pb-20px ps-50px pe-50px position-relative text-center">
                                                    <a href="move-out-cleaning.php" class="btn btn-link btn-hover-animation-switch btn-medium fw-700 text-dark-gray text-uppercase">
                                                        <span>
                                                            <span class="btn-text">Explore services</span>
                                                            <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
                                                            <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
            ...
            <div class="container">
                <div class="row align-items-center mb-8 sm-mb-50px justify-content-md-center"> 
                    <div class="col-xl-5 col-lg-6 col-md-12 md-mb-50px" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'> 
                        ...
                        <div>
                            <a href="demo-logistics-our-services.php" class="btn btn-large btn-dark-gray btn-hover-animation-switch btn-round-edge btn-box-shadow me-15px">
                                <span> 
                    ...
                    <div class="col-xl-6 col-lg-6 offset-xl-1 position-relative">
                        <div class="w-80 ms-auto" data-animation-delay="200" data-shadow-animation="true" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)">
                            <img src="images/9.jpg" alt="" class="border-radius-10px w-100">
                        </div>
        ...
        <!-- start section -->
        <section class="ps-8 pe-8 lg-ps-4 lg-pe-4 md-ps-0 md-pe-0 pt-1 pb-4">
                        ...
                        <form action="email-templates/contact-form.php" method="post" class="row contact-form-style-01">    
                            <div class="col-md-6 mb-30px sm-mb-20px">
                                ...
                                <div class="position-relative form-group mb-20px">
                                    ...
                                    <input class="input-name box-shadow-double-large form-control required" type="text" name="phone" placeholder="FROM STREET ADDRESS(Required)" />
                                </div>

                                <div class="position-relative form-group mb-20px">
                                    <span class="form-icon"><i class="bi bi-calendar-check"></i></span>
                                    <input class="input-name box-shadow-double-large form-control required" type="text" name="phone" placeholder="MOVING DATE" />
                                </div>
                            ...
                            <div class="col-md-6 mb-30px">
                                ...
                                <div class="position-relative form-group select mb-20px">
                                    ...
                                    <select class="form-control box-shadow-double-large" name="booking-city" aria-label="select-city-booking">
                                        <option value="">TYPE OF MOVE(Required)</option>
                                ...
                                <div class="position-relative form-group mb-20px">
                                    <span class="form-icon"><i class="bi bi-house-door"></i></span>
                                    <input class="input-name box-shadow-double-large form-control required" type="text" name="phone" placeholder="TO STREET ADDRESS(Required)" />
                                </div>
                               
                                <div class="position-relative form-group form-textarea">
                                    <span class="form-icon"><i class="bi bi-chat-left-dots"></i></span>
                                    <textarea class="box-shadow-double-large form-control" cols="40" rows="4" name="delivery-address" placeholder="Any thing else we need to know?"></textarea>
                                </div>
                            </div>
